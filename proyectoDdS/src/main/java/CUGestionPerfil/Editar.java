...
public class Editar extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            // Crear una instancia de Perfil (supongo que es tu frame de edición)
            Perfil perfil = new Perfil();
            perfil.setVisible(true);
            ...
            //Date fechaNacimiento = DateNacimiento.getDate(); // Obtener fecha seleccionada

            /**
            if (fechaNacimiento == null) {
                // Si no se seleccionó una fecha, muestra un mensaje de error
                JOptionPane.showMessageDialog(this, "Debes seleccionar una fecha de nacimiento", "Error", JOptionPane.ERROR_MESSAGE);
                return; // Detener la ejecución si hay un error
            }
            * */

            // Crear un objeto UsuarioDTO con los datos ingresados
            UsuarioDTO usuarioDTO = new UsuarioDTO();
            usuarioDTO.setNombre(nombre);
            usuarioDTO.setCorreo(correo);
            //usuarioDTO.setNacimiento(fechaNacimiento);
            
            

            // Crear una instancia de Administrador (subsistema)
            Administrador administrador = new Administrador();

            // Llamar al método para editar o actualizar
            administrador.actualizar(usuarioDTO); // O administrador.actualizar(usuarioDTO)

            // Mostrar mensaje de confirmación o éxito
            JOptionPane.showMessageDialog(this, "Usuario actualizado correctamente", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } catch (Exception e) {
            // Manejar excepciones (por ejemplo, campos vacíos o errores de base de datos)
